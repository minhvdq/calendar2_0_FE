            ...
            <form onSubmit={handleSignup}>
              <div className="row justify-content-center">
                ...
                <div className='input-group mb-1'>
                  <input type="text" className="form-control form-control-lg bg-light fs-6" id="exampleFormControlInput1" placeholder="name@example.com" value={email} onChange={(e) => {e.preventDefault(); setEmail(e.target.value)}} required />
                </div>
              </div>
              <div className="row justify-content-center">
                <label htmlFor="inputPassword" className="col-form-label">Password</label>
                <div className='input-group mb-1'>
                  <input type="text" id="inputPassword" className="form-control form-control-lg bg-light fs-6" aria-describedby="passwordHelpInline" placeholder='Your Password' value={password} onChange={(e) => {e.preventDefault(); setPassword(e.target.value)}} required />
                </div>
              </div>
              <div className="row justify-content-center">
                <label htmlFor="inputPassword" className="col-form-label">Confirm Password</label>
                <div className='input-group mb-1'>
                  <input type="text" id="inputConfirmPassword" className="form-control form-control-lg bg-light fs-6" aria-describedby="passwordHelpInline" placeholder='Confirm Your Password' value={repPassword} onChange={(e) => {e.preventDefault(); setRepPassword(e.target.value)}} required />
                </div>
              </div>
